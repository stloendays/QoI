# Supplementary Figure S2 — QSQ perturbation-probe robustness
...
# the 18-material pre-freeze calibration statistics documented in the frozen internal protocol record.
seed2 <- seed %>%
